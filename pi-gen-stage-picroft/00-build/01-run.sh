...
install -m 0755 -o "${FIRST_USER_NAME}" "files/home/pi/audio_setup.sh" "${ROOTFS_DIR}/home/pi/audio_setup.sh"
install -m 0755 -o "${FIRST_USER_NAME}" "files/home/pi/auto_run.sh" "${ROOTFS_DIR}/home/pi/auto_run.sh"
install -m 0755 -o "${FIRST_USER_NAME}" "files/home/pi/custom_setup.sh" "${ROOTFS_DIR}/home/pi/custom_setup.sh"
install -m 0755 -o "${FIRST_USER_NAME}" "files/home/pi/update.sh" "${ROOTFS_DIR}/home/pi/update.sh"

install -d -m 0755 -o "${FIRST_USER_NAME}" "${ROOTFS_DIR}/home/pi/bin"
install -m 0755 -o "${FIRST_USER_NAME}" "files/home/pi/bin/mycroft-setup-wizard" "${ROOTFS_DIR}/home/pi/bin/mycroft-setup-wizard"
install -m 0755 -o "${FIRST_USER_NAME}" "files/home/pi/bin/mycroft-wipe" "${ROOTFS_DIR}/home/pi/bin/mycroft-wipe"
